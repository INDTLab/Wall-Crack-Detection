...
class Conv(nn.Module):
    ...
    #     return output
        ...
        self.depthwise_conv = nn.Conv2d(nIn, nIn, kernel_size=kSize,
                                        stride=stride, padding=padding,
                                        dilation=dilation, groups=nIn, bias=bias)
        self.pointwise_conv = nn.Conv2d(nIn, nOut, kernel_size=1, stride=1, padding=0, bias=bias)
...
#DECODER
        ...
        for i in range(0, block_4):
           self.DAB_Block_4.add_module("DAB_Module_4_" + str(i),
                                       DABModule(256, d=dilation_block_4[i]))
        self.upsample_1 = UpsampleingBlock(256, 128)
        ...
        for i in range(0, block_5):
            self.DAB_Block_5.add_module("DAB_Module_5_" + str(i),
                                        DABModule(128, d=dilation_block_5[i]))
        self.upsample_2 = UpsampleingBlock(128, 64)
        self.bn_prelu_6 = BNPReLU(64)
        ...
        for i in range(0, block_6):
            self.DAB_Block_6.add_module("DAB_Module_6_" + str(i),
                                        DABModule(64, d=dilation_block_6[i]))
        ...
        self.LC1 = LongConnection(64, 64, 3)
        self.LC2 = LongConnection(128, 128, 3)
...
#DECODER            
        ...
        output4 = self.upsample_1(output4 + (output3))
